...
import org.openo.sdnhub.sptndriver.models.south.SL3BindRelation;
import org.openo.sdnhub.sptndriver.models.south.SL3ac;
import org.openo.sdnhub.sptndriver.models.north.NL3Vpn;
import org.openo.sdnhub.sptndriver.models.south.SL3Frr;
...
public class L3ConverterTest {
    ...
    public void testFullMesh() throws Exception {
       compareInputAndOutput("src/test/resources/json/create_l3vpn_input.json",
           "src/test/resources/json/create_l3vpn_output.json");
    }

    @Test
    public void testHubSpoke() throws Exception {
        compareInputAndOutput("src/test/resources/json/hub_spoke_policy_input.json",
            "src/test/resources/json/hub_spoke_policy_output.json");
    }

    @Test
    public void testAcQos() throws Exception {
        compareInputAndOutput("src/test/resources/json/ac_qos_input.json",
            "src/test/resources/json/ac_qos_output.json");
    }
