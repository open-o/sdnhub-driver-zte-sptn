...
import org.openo.sdnhub.sptndriver.common.DriverManagerRegister;
import org.openo.sdnhub.sptndriver.common.DriverManagerUnregister;
import org.openo.sdnhub.sptndriver.config.AppConfig;
import org.openo.sdnhub.sptndriver.healthcheck.CustomHealthCheck;
import org.openo.sdnhub.sptndriver.resources.L2Resource;
import org.openo.sdnhub.sptndriver.resources.L3Resource;
...
public class App extends Application<SptnDriverConfig> {
    ...
    private void initSwaggerConfig(SptnDriverConfig configuration, Environment environment) {
        ...
        config.setTitle("Open-O SDNHUB ZTE SPTN Drvier API");
        config.setVersion("1.1.0");
        config.setResourcePackage("org.openo.sdnhub.sptndriver.resources");
    ...
    private class AppLifeCycleListener implements LifeCycle.Listener {
        ...
        private void unregisterFromDriverMgr() {
            ...
            driverManagerUnregister.setName("Unregister sdn-o sptn driver from Driver Manager");
