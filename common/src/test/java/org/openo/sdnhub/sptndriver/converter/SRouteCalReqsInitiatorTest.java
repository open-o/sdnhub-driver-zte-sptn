...
public class SRouteCalReqsInitiatorTest {
    ...
    public void initElineLspCalRoute() throws Exception {
        SRouteCalReqsInput calculated
            = getCalculateResult("src/test/resources/json/cal_tunnel_route_input.json");
        SRouteCalReqsInput expected
            = getExpected("src/test/resources/json/cal_tunnel_route_output.json");
    ...
    public void test_particular_constraint_not_empty() throws Exception {
        SRouteCalReqsInput calculated
            = getCalculateResult("src/test/resources/json/routecalreqs/particular_constraint_not_empty_input.json");
        SRouteCalReqsInput expected
            = getExpected("src/test/resources/json/routecalreqs/particular_constraint_not_empty_output.json");
        Assert.assertEquals(expected, calculated);
    }
    ...
    public void test_ne_empty() throws Exception {
        try {
            getCalculateResult("src/test/resources/json/routecalreqs/ne_empty_input.json");
    ...
    public void test_use_pw_ne() throws Exception {
        SRouteCalReqsInput calculated
            = getCalculateResult("src/test/resources/json/routecalreqs/ac_empty_pw_not_empty_input.json");
        SRouteCalReqsInput expected
            = getExpected("src/test/resources/json/routecalreqs/ac_empty_pw_not_empty_output.json");
        Assert.assertEquals(expected, calculated);
    }
    ...
    public void test_no_protection_and_not_best_effort() throws Exception {
        SRouteCalReqsInput calculated
            = getCalculateResult("src/test/resources/json/routecalreqs/no_protection_not_besteffort_input.json");
        SRouteCalReqsInput expected
            = getExpected("src/test/resources/json/routecalreqs/no_protection_not_besteffort_output.json");
        Assert.assertEquals(expected, calculated);
    }
