...
public class SSncSwitchInitiatorTest {
    ...
    public void test_pw_sncswitch() throws Exception {
        SSncSwitch expectedValue = JsonUtil.parseJsonFromFile(
            "src/test/resource/json/sncswitch/pw_output.json", SSncSwitch.class);
    ...
    public void test_not_revertive() throws Exception {
        SSncSwitch expectedValue = JsonUtil.parseJsonFromFile(
            "src/test/resource/json/sncswitch/nonrevertive_output.json", SSncSwitch.class);
        NMplsTePolicy mplsTePolicy = JsonUtil.parseJsonFromFile(
            "src/test/resource/json/sncswitch/nonrevertive_input.json", NMplsTePolicy.class);
    ...
    public void test_unprotected() throws Exception {
        SSncSwitch expectedValue = JsonUtil.parseJsonFromFile(
            "src/test/resource/json/sncswitch/unprotected_output.json", SSncSwitch.class);
    ...
    public void test_with_recovery_1_to_1() throws Exception {
        SSncSwitch expectedValue = JsonUtil.parseJsonFromFile(
            "src/test/resource/json/sncswitch/coroute_output.json", SSncSwitch.class);
        NMplsTePolicy mplsTePolicy = JsonUtil.parseJsonFromFile(
            "src/test/resource/json/sncswitch/coroute_input.json", NMplsTePolicy.class);
        SSncSwitch actualValue = SSncSwitchInitiator.initLspSncSwitch(mplsTePolicy);
        Assert.assertEquals(expectedValue, actualValue);
    }
}