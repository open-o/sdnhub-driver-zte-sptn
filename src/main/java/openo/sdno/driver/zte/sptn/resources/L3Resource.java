package openo.sdno.driver.zte.sptn.resources;
...
import openo.sdno.driver.zte.sptn.models.south.L3vpn;
...
public class L3Resource {
  ...
  @POST
  public javax.ws.rs.core.Response createEline(L3vpn L3) throws URISyntaxException {

    return Response.created(new
                                URI(String.valueOf(new L3vpn()))).build();
